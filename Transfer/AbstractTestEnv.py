...
from sofagym.env.common.rpc_server_test import start_server, add_new_step, get_result, clean_registry, close_scene
...
class AbstractEnv(gym.Env):
    ...
    def __init__(self, config = None):
        ...
        #NOTE: we can put it in initialization to change the adress of the server
        #(warning: we will have a lot of opening and closing of session, that can
        #lead to problem in adress allocation)
        self.initialization()
    ...
    def initialization(self):
        ...
        self.configure({"save_path_image": save_path_image,
